...
class ReadHostSkillTool(Tool):
    """Host skill reading tool - allows agent to read and use specific skills"""
    
    name = "read_host_skill"
    ...
    async def get_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "function": {
                "name": self.name,
                "description": f"Read a host skill document under {self.skill_dir}. "
                    "MUST read before handling tasks matching an available host skill's domain. "
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "skill_document": {
                            "type": "string",
                            "description": "Relative document path within the skill directory to read.",
