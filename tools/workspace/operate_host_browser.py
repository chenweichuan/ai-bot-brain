...
class OperateHostBrowserTool(Tool):
    """Operate host browser to perform web interaction actions"""
    
    name = "operate_host_browser"
    ...
    async def get_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "function": {
                "name": self.name,
                "description": "Operate the host browser to perform web interaction actions, including navigation, dialog interaction, execute JavaScript, etc. "
