            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "operation": {
                            "type": "string",
                            "enum": ["goto", "evaluate", "new_tab", "switch_tab", "list_tabs", "close_tab",
                                      "wait", "upload", "dialog_accept", "dialog_dismiss",
    ...
    async def execute(self, arguments: str) -> tuple[Union[str, List[Dict[str, Any]]], str]:
        ...
        try:
            ...
            if operation == "new_tab":
                ...
                if 0 <= tab_index < len(_pages):
                    if len(_pages) == 1:
                        # If only one tab, create a new tab before closing to avoid browser closure
